...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QSize(796, 849))
        font = QFont()
...
"}")
        ...
        self.actionAddExcelFile.setIcon(icon1)
        ...
        self.actionSetSavePath.setIcon(icon2)
        self.actionSetGlobalPassword = QAction(MainWindow)
        self.actionSetGlobalPassword.setObjectName(u"actionSetGlobalPassword")
        icon3 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.SystemLockScreen))
        self.actionSetGlobalPassword.setIcon(icon3)
        ...
        self.actionSetOutputEncryption.setIcon(icon4)
        ...
        icon6 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.ToolsCheckSpelling))
        self.actionActivateDebugMode.setIcon(icon6)
        self.actionVisitBlog = QAction(MainWindow)
        self.actionVisitBlog.setObjectName(u"actionVisitBlog")
        icon7 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.GoHome))
        self.actionVisitBlog.setIcon(icon7)
        self.actionWin32 = QAction(MainWindow)
        self.actionWin32.setObjectName(u"actionWin32")
        self.actionWin32.setCheckable(True)
        icon8 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.WindowNew))
        self.actionWin32.setIcon(icon8)
        ...
        self.menu_2.addAction(self.actionWin32)
        self.menu_3.addAction(self.actionVisitBlog)
...
#if QT_CONFIG(shortcut)
        self.actionActivateDebugMode.setShortcut(QCoreApplication.translate("MainWindow", u"Alt+D", None))
#endif // QT_CONFIG(shortcut)
        self.actionVisitBlog.setText(QCoreApplication.translate("MainWindow", u"\uc81c\uc791\uc790 \ube14\ub85c\uadf8", None))
        self.actionWin32.setText(QCoreApplication.translate("MainWindow", u"\uace0\ud488\uc9c8 \ubaa8\ub4dc \ud65c\uc131\ud654", None))
#if QT_CONFIG(shortcut)
        self.actionWin32.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+U", None))
#endif // QT_CONFIG(shortcut)
...
#if QT_CONFIG(shortcut)
        self.radioButtonAll.setShortcut(QCoreApplication.translate("MainWindow", u"A", None))
#endif // QT_CONFIG(shortcut)
        self.radioButtonSpecific.setText(QCoreApplication.translate("MainWindow", u"\ud2b9\uc815 \uc2dc\ud2b8", None))
#if QT_CONFIG(shortcut)
        self.radioButtonSpecific.setShortcut(QCoreApplication.translate("MainWindow", u"S", None))
#endif // QT_CONFIG(shortcut)
...
#if QT_CONFIG(shortcut)
        self.radioButtonChoice.setShortcut(QCoreApplication.translate("MainWindow", u"D", None))
#endif // QT_CONFIG(shortcut)
...
#if QT_CONFIG(shortcut)
        self.checkBoxOnlyValue.setShortcut(QCoreApplication.translate("MainWindow", u"V", None))
#endif // QT_CONFIG(shortcut)
