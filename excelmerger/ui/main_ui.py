...
"}")
        ...
        icon4 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.ToolsCheckSpelling))
        self.actionActivateDebugMode.setIcon(icon4)
        ...
        self.actionVisitBlog.setIcon(icon5)
        self.actionWin32 = QAction(MainWindow)
        self.actionWin32.setObjectName(u"actionWin32")
        self.actionWin32.setCheckable(True)
        icon6 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.WindowNew))
        self.actionWin32.setIcon(icon6)
